        ...
        AlertDialog dialog = new MaterialAlertDialogBuilder(this)
                ...
                .setMessage(Html.fromHtml("""
                                <b>Version 2.1.0:</b><br>
                                    - Added button to navigate to parent comment<br>
                                    - Redirect Twitter to Nitter now applies to URLs clicked as well<br>
                                    - Filter stories based on a minimum score<br>
                                    - Filter stories based on blocked domain names<br>
                                    - Changed default setting for Always show comments to true<br>
                                    <br>
